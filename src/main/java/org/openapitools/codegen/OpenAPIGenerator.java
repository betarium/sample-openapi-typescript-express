...
public class OpenAPIGenerator {
    ...
    public static void main(String[] args) {
        class GenerateCustomCommand implements CommandFactory<OpenApiGeneratorCommand> {
            @Override
            public OpenApiGeneratorCommand createInstance(Class<?> aClass) {
                return new GenerateCustom();
            }
        }
