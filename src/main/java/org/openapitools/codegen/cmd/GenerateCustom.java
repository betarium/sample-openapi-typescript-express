...
import org.openapitools.codegen.config.CodegenConfiguratorCustom;
...
public class GenerateCustom extends OpenApiGeneratorCommand {

    CodegenConfigurator configurator = new CodegenConfiguratorCustom();
    Generator generator;
